...
function closeback() {
    $(".hello-juru").removeClass("hello-hide"), $(".content-juru").removeClass("content-juru-show"), $(".more").removeClass("more-hide"), $(".overlay").removeClass("overlay-show"), $(".container").scrollTop()
}

function buttonStatus() {
    var e = $("#send");
    "" != $("select").val() && "" != $("input").val() && "" != $("textarea").val() ? (e.removeClass("btn-disable"), e.removeAttr("disabled")) : (e.addClass("btn-disable"), e.attr("disabled"))
}! function(e, t) {
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, u, l, p, d = t.createDocumentFragment(), h = [], g = 0, v = e.length; v > g; g++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = (Me.exec(o) || ["", ""])[1].toLowerCase(), u = He[a] || He._default, s.innerHTML = u[1] + oe.htmlPrefilter(o) + u[2], p = u[0]; p--;) s = s.lastChild;
        ...
        for (d.textContent = "", g = 0; o = h[g++];)
            ...
            for (p = 0; o = s[p++];) $e.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function C(e, t, n, r) {
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (a)
                for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) u = s[f], $e.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(Ue, "")))
        }
        return e
    }
    ...
    function E(e) {
        var t = Y,
            n = Qe[e];
        return n || (n = k(e, t), "none" !== n && n || (Xe = (Xe || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Xe[0].contentDocument, t.write(), t.close(), n = k(e, t), Xe.detach()), Qe[e] = n), n
    }
    ...
    function O(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = Ee.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Oe(r) && (o[s] = Ee.access(r, "olddisplay", E(r.nodeName)))) : (i = Oe(r), "none" === n && i || Ee.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function H(e, t, n) {
        for (var r, i = (F.tweeners[t] || []).concat(F.tweeners["*"]), o = 0, s = i.length; s > o; o++)
    ...
    function I(e, t, n) {
        ...
        if (oe.isEmptyObject(p)) "inline" === ("none" === l ? E(e.nodeName) : l) && (d.display = l);
            ...
            for (r in p) s = H(h ? g[r] : 0, r, f), r in g || (g[r] = s.start, h && (s.end = s.start, s.start = "width" === r || "height" === r ? 1 : 0))
        }
    }
    ...
    function F(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = it || M(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
        ...
        return oe.map(c, H, l), oe.isFunction(l.opts.start) && l.opts.start.call(e, l), oe.fx.timer(oe.extend(u, {
            elem: e,
            anim: l,
            queue: l.opts.queue
    ...
    var ce = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : R) !== O && q(t), t = t || O, M)) {
                if (11 !== g && (l = me.exec(e)))
                    if (i = l[1]) {
                        if (9 === g) {
                ...
                if (w.qsa && !U[e + " "] && (!$ || !$.test(e))) {
                    if (1 !== g) h = t, d = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(xe, "\\$&") : t.setAttribute("id", a = F), f = E(e), o = f.length, u = pe.test(a) ? "#" + a : "[id='" + a + "']"; o--;) f[o] = u + " " + p(f[o]);
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                if (s) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || i) {
                            if (l = t[F] || (t[F] = {}), u = l[t.uniqueID] || (l[t.uniqueID] = {}), (a = u[r]) && a[0] === W && a[1] === o) return c[2] = a[2];
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = d(function(e) {
                ...
                if (n = C.relative[e[a].type]) c = [d(h(c), n)];
                else {
            ...
            var i = n.length > 0,
                ...
                s = function(r, s, a, u, l) {
                    ...
                    for (l && (N = s === O || s || l); h !== w && null != (c = x[h]); h++) {
                        if (o && c) {
                            for (f = 0, s || c.ownerDocument === O || (q(c), a = !M); p = e[f++];)
                                if (p(c, s || O, a)) {
                                    u.push(c);
                                    break
                                }
        ...
        var b, w, C, T, k, E, S, j, N, A, D, q, O, L, M, $, H, I, P, F = "sizzle" + 1 * new Date,
            R = e.document,
            W = 0,
            B = 0,
            _ = n(),
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return r !== O && 9 === r.nodeType && r.documentElement ? (O = r, L = O.documentElement, M = !k(O), (n = O.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = i(function(e) {
            ...
            }), $ = $.length && new RegExp($.join("|")), H = H.length && new RegExp(H.join("|")), t = ve.test(L.compareDocumentPosition), P = t || ve.test(L.contains) ? function(e, t) {
            ...
            if ((e.ownerDocument || e) !== O && q(e), n = n.replace(ce, "='$1']"), w.matchesSelector && M && !U[n + " "] && (!H || !H.test(n)) && (!$ || !$.test(n))) try {
                var r = I.call(e, n);
                if (r || w.disconnectedMatch || e.document && 11 !== e.document.nodeType) return r
            } catch (i) {}
            return t(n, O, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== O && q(e), P(e, t)
        }, t.attr = function(e, t) {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (v) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                for (p = v, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d && l[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                    if (1 === p.nodeType && ++x && p === t) {
                                        c[e] = [W, d, x];
                                        break
                                    }
                            } else if (y && (p = t, f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d), x === !1)
                                for (;
                                    (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[F] || (p[F] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [W, x]), p !== t)););
        ...
        return f.prototype = C.filters = C.pseudos, C.setFilters = new f, E = t.tokenize = function(e, n) {
            ...
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && M && C.relative[o[1].type]) {
        ...
        }, w.sortStable = F.split("").sort(X).join("") === F, w.detectDuplicates = !!D, q(), w.sortDetached = i(function(e) {
    ...
    oe.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --oe.readyWait : oe.isReady) || (oe.isReady = !0, e !== !0 && --oe.readyWait > 0 || (Ce.resolveWith(Y, [oe]), oe.fn.triggerHandler && (oe(Y).triggerHandler("ready"), oe(Y).off("ready"))))
        }
    }), oe.ready.promise = function(t) {
        return Ce || (Ce = oe.Deferred(), "complete" === Y.readyState || "loading" !== Y.readyState && !Y.documentElement.doScroll ? e.setTimeout(oe.ready) : (Y.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), Ce.promise(t)
    }, oe.ready.promise();
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                for (n.handler && (o = n, n = o.handler, i = o.selector), n.guid || (n.guid = oe.guid++), (u = v.events) || (u = v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
                    ...
                    }), t = (t || "").match(we) || [""], l = t.length; l--;) a = Re.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        remove: function(e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (t = (t || "").match(we) || [""], l = t.length; l--;)
                    if (a = Re.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
    ...
    oe.extend({
        ...
        html: function(e) {
            return Te(this, function(e) {
                ...
                if ("string" == typeof e && !Be.test(e) && !He[(Me.exec(e) || ["", ""])[1].toLowerCase()]) {
            ...
            finish: function(e) {
                return e !== !1 && (e = e || "fx"), this.each(function() {
                    var t, n = Ee.get(this),
                        ...
                        o = oe.timers,
                        s = r ? r.length : 0;
                    for (n.finish = !0, oe.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length; t--;) o[t].elem === this && o[t].queue === e && (o[t].anim.stop(!0),
                        o.splice(t, 1));
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || Y, 3 !== r.nodeType && 8 !== r.nodeType && !gt.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
    ...
    Nt.href = vt.href, oe.extend({
        ...
        ajax: function(t, n) {
            function r(t, n, r, a) {
                var l, f, y, x, w, T = n;
                2 !== b && (b = 2, u && e.clearTimeout(u), i = void 0, s = a || "", C.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, r && (x = z(p, C, r)), x = U(p, x, C, l), l ? (p.ifModified && (w = C.getResponseHeader("Last-Modified"), w && (oe.lastModified[o] = w), w = C.getResponseHeader("etag"), w && (oe.etag[o] = w)), 204 === t || "HEAD" === p.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = x.state, f = x.data, y = x.error, l = !y)) : (y = T, !t && T || (T = "error", 0 > t && (t = 0))), C.status = t, C.statusText = (n || T) + "", l ? g.resolveWith(d, [f, T, C]) : g.rejectWith(d, [C, T, y]), C.statusCode(m), m = void 0, c && h.trigger(l ? "ajaxSuccess" : "ajaxError", [C, p, l ? f : y]), v.fireWith(d, [C, T]), c && (h.trigger("ajaxComplete", [C, p]), --oe.active || oe.event.trigger("ajaxStop")))
            }
            ...
            if (g.promise(C).complete = v.add, C.success = C.done, C.error = C.fail, p.url = ((t || p.url || vt.href) + "").replace(xt, "").replace(kt, vt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = oe.trim(p.dataType || "*").toLowerCase().match(we) || [""], null == p.crossDomain) {
                l = Y.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = oe.param(p.data, p.traditional)), B(Et, p, n, C), 2 === b) return C;
            c = oe.event && p.global, c && 0 === oe.active++ && oe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (yt.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = bt.test(o) ? o.replace(bt, "$1_=" + mt++) : o + (yt.test(o) ? "&" : "?") + "_=" + mt++)), p.ifModified && (oe.lastModified[o] && C.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && C.setRequestHeader("If-None-Match", oe.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && C.setRequestHeader("Content-Type", p.contentType), C.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + jt + "; q=0.01" : "") : p.accepts["*"]);
    ...
    re.cors = !!$t && "withCredentials" in $t, re.ajax = $t = !!$t, oe.ajaxTransport(function(t) {
        var n, r;
        return re.cors || $t && !t.crossDomain ? {
            send: function(i, o) {
                var s, a = t.xhr();
                ...
                n = function(e) {
                    return function() {
                        n && (n = r = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Mt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                            binary: a.response
                        } : {
                            text: a.responseText
    ...
    oe.ajaxSetup({
        ...
        var i, o, s, a = t.jsonp !== !1 && (It.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && It.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(It, "$1" + i) : t.jsonp !== !1 && (t.url += (yt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return s || oe.error(i + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
            s = arguments
        }, r.always(function() {
            void 0 === o ? oe(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Ht.push(i)), s && oe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script") : void 0
    ...
    function() {
        ...
        t = function() {
            ...
            return e.prototype.get = function(e) {
                var t, n, r, i, o;
                for (o = this.keys, t = r = 0, i = o.length; i > r; t = ++r)
                    if (n = o[t], n === e) return this.values[t]
            }, e.prototype.set = function(e, t) {
                var n, r, i, o, s;
                for (s = this.keys, n = i = 0, o = s.length; o > i; n = ++i)
                    if (r = s[n], r === e) return void(this.values[n] = t);
                return this.keys.push(e), this.values.push(t)
            }, e
        }()), e = this.MutationObserver || this.WebkitMutationObserver || this.MozMutationObserver || (e = function() {
            function e() {
                "undefined" != typeof console && null !== console, "undefined" != typeof console && null !== console
            }
            ...
            return i.prototype.defaults = {
                ...
                if (this.stopped = !1, this.boxes = function() {
                        var e, n, r, i;
                        for (r = this.element.querySelectorAll("." + this.config.boxClass), i = [], e = 0, n = r.length; n > e; e++) t = r[e], i.push(t);
                        return i
                    }.call(this), this.all = function() {
                        var e, n, r, i;
                        for (r = this.boxes, i = [], e = 0, n = r.length; n > e; e++) t = r[e], i.push(t);
                        return i
                ...
                return this.disabled() || (this.util().addEvent(window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new e(function(e) {
                    return function(t) {
                        var n, r, i, o, s;
                        for (s = [], n = 0, r = t.length; r > n; n++) o = t[n], s.push(function() {
                            var e, t, n, r;
                            for (n = o.addedNodes || [], r = [], e = 0, t = n.length; t > e; e++) i = n[e], r.push(this.doSync(i));
                            return r
                        }.call(e));
                        return s
                    }
                ...
                if (null == e && (e = this.element), 1 === e.nodeType) {
                    for (e = e.parentNode || e, i = e.querySelectorAll("." + this.config.boxClass), o = [], n = 0, r = i.length; r > n; n++) t = i[n], s.call(this.all, t) < 0 ? (this.boxes.push(t), this.all.push(t), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(t, !0), o.push(this.scrolled = !0)) : o.push(void 0);
                    return o
                }
                ...
                var e, t, n, r, i;
                for (r = this.boxes, i = [], t = 0, n = r.length; n > t; t++) e = r[t], i.push(e.style.visibility = "visible");
                return i
                ...
                var n, i, o, s, a, u;
                for (a = r(e), s = a.getPropertyCSSValue(t), o = this.vendors, n = 0, i = o.length; i > n; n++) u = o[n], s = s || a.getPropertyCSSValue("-" + u + "-" + t);
                return s
                ...
                var t, n, r, i, o;
                return n = e.getAttribute("data-wow-offset") || this.config.offset, o = window.pageYOffset, i = o + Math.min(this.element.clientHeight, this.util().innerHeight()) - n, r = this.offsetTop(e), t = r + e.clientHeight, i >= r && t >= o
    ...
    }), animations(), $(".more").on("click", function() {
        $(".hello-juru").toggleClass("hello-hide"), $(".content-juru").toggleClass("content-juru-show"), $(".more").toggleClass("more-hide"), $(".overlay").toggleClass("overlay-show")
    }), $(".overlay").on("click", function() {
        closeback()
    }), $(".close-content").on("click", function() {
        closeback()
    }), $(".go-to-kerjasama").on("click", function() {
        $("body").toggleClass("open-page"), $("body").toggleClass("no-scroll"), $("#kerjasama").addClass("box-page__inner-show")
    }), $(".go-to-contact").on("click", function() {
        $("body").toggleClass("open-page"), $("body").toggleClass("no-scroll"), $("#kontak").addClass("box-page__inner-show")
    }), $(".go-to-pasar").on("click", function() {
        $(".soon").addClass("soon_open"), $("body").addClass("no-scroll"), $("h2.for-heading-juru").text("JURU PASAR"), $("p.for-desc-juru").text("JURU Pasar merupakan sistem manajemen pengelolaan pasar untuk memberi kemudahan dalam hal proses pencatatan, pemetaan, dan pemantauan pembayaran retribusi pasar yang dilengkapi juga dengan dengan fitur update harga komoditas yang berfungsi untuk mengetahui fluktuasi harga komoditas yang dijual oleh pedagang setiap harinya.")
    }), $(".go-to-bersih").on("click", function() {
        $(".soon").addClass("soon_open"), $("body").addClass("no-scroll"), $(".for-heading-juru").text("JURU BERSIH"), $(".for-desc-juru").text("JURU Bersih merupakan aplikasi manajemen pengelolaan pengangkutan sampah berbasis teknologi aplikasi untuk meningkatkan efektifitas dan efisiensi proses pengangkutan sampah serta transparansi laporan penagihan sehingga mengurangi resiko kebocoran retribusi sampah.")
    }), $(".kembali").on("click", function() {
        $(".soon").removeClass("soon_open"), $("body").removeClass("no-scroll")
    }), $(".close-page").on("click", function() {
        $("body").removeClass("open-page"), $("body").removeClass("no-scroll"), $("#email").val(""), $("#desc").val(""), $("#city").val(""), $("#send").addClass("btn-disable"), $("#send").attr("disabled"), $(".kerjasama").removeClass("kerjasama-hide"), $(".alert-kerjasama").removeClass("alert-kerjasama-show"), $(".proses").html("KIRIM"), $("#kerjasama").removeClass("box-page__inner-show"), $("#kontak").removeClass("box-page__inner-show")
    }), $(window).load(function() {
        $(".loading").fadeOut("slow"), $(".preload").delay(500).fadeOut("slow")
    }), $("input,select").on("keyup change", function() {
        buttonStatus()
    }), $(".proses").on("click", function() {
        $(this).html('PROSES<span class="spinner"></span>'), $(".form-kerjasama").submit(function(e) {
            e.preventDefault(), setTimeout(function() {
                $(".kerjasama").addClass("kerjasama-hide"), $(".alert-kerjasama").addClass("alert-kerjasama-show")
            }, 2e3)
        })
    });